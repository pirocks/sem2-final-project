 ...
 */
public class FactorySpaceCraftMedium extends FactorySpaceCraft {
	...
	protected FactorySpaceCraftMedium(VehicleInitialConstants vehicleInitialConstants, int numToolsConstructor) {
